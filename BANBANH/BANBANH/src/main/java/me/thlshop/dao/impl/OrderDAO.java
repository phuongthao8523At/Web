...
public class OrderDAO implements IOrderDAO{
	...
	public List<OrderEntity> findByUser(Integer userId) {
		String hql = "SELECT o FROM OrderEntity o JOIN FETCH o.orderDetails od JOIN FETCH od.productId p WHERE o.userId.userId = :userId ORDER BY o.orderId DESC";
		Transaction transaction = null;
	...
	public List<OrderEntity> findAll() {
		...
		String hql = "SELECT o FROM OrderEntity o ORDER BY o.orderId DESC";
		try {
			Session session = DBUtil.getSessionFactory().openSession();
			transaction = session.beginTransaction();
			@SuppressWarnings("rawtypes")
